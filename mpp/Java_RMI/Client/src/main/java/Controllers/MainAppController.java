...
public class MainAppController extends UnicastRemoteObject implements IObserver, Serializable {
    ...
    private void loadFromDatabase() {
        try {
            ...
            List<Caritate> list = (List<Caritate>) service.findAll();
    ...
    @FXML public void addDonatie() {
        try {
            ...
            service.save(nume, adresa, nrTel, suma, caritate.getNume());
    ...
    @FXML private void onSearch() {
        try {
            ...
            ArrayList<Donatie> al = (ArrayList<Donatie>) service.searchByName(searched);
